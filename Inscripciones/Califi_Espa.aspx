<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Califi_Espa.aspx.cs" Inherits="Inscripciones.Califi_Espa" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label2" runat="server" Text="Español"></asp:Label>
            <br />
            Calificación Actual:
